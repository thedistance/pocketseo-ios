...
extension ViperTesting {
    ...
    func setupDependencies() {
        ...
        dependencies.crashReportingInteractor = TestCrashInteractor()
        
        dependencies.preferencesInteractor?.setDefaultPreferences()
        dependencies.analyticsInteractor?.setupAnalytics()
        dependencies.crashReportingInteractor?.setupCrashReporting()
    }
